...
<head>
    ...
    <script src="https://kit.fontawesome.com/1ffb579a49.js" crossorigin="anonymous"></script>
...
<nav>
    <span>Introduzione</span>
        ...
        <span class="blue">Domande frequenti</span>
    </nav>

<main>
    <div class="cont">
        
        <?php foreach($doc as $paragraph){?>
            <h1><?php echo $paragraph['domande']?></h1>

                <?php foreach($paragraph['risposte'] as $risposte){?>
                    <h5 class="risp"><?php echo $risposte?></h5>
                <?php }?>
